...
| | |
|---|---|
| Application source | 25,301 lines across 54 modules (`src/`) |
| Test and build tooling | 9,403 lines across 41 files (`tools/`, `desktop/`) |
...
| | |
|---|---|
| Headless checks | 935 across 17 suites, about four seconds, downloads nothing |
